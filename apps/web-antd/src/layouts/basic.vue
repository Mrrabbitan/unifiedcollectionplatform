...
<template>
  ...
  >
    <template #header-right-45>
      <Spin :spinning="projectStore.loading" size="small">
        <div style="display: flex; align-items: center; gap: 8px;">
          <span style="color: rgba(0, 0, 0, 0.85); font-size: 14px;">项目</span>
          <Select
            v-model:value="projectStore.currentProjectCode"
            :options="projectStore.projectOptions"
            placeholder="选择项目"
            style="min-width: 150px"
            :loading="projectStore.loading"
            @change="projectStore.setCurrentProject"
          />
        </div>
      </Spin>
    </template>
